  ...
  render() {
    return (
      <div className="absolute w-screen h-screen">
        <div className="z-20 absolute inset-0 w-screen h-16 pt-4 flex place-items-center">
          ...
          <button
            ...
            className="pl-4 pr-3 py-1 mr-12 bg-blue-dark font-cursive text-xl text-white rounded-md focus:outline-none"
          >
            Back to home
          </button>
        </div>
        <div className="z-30 absolute w-screen h-screen bg-blue-dark opacity-50 backdrop-blur"></div>
        <div className="z-40 absolute w-screen h-screen flex justify-center place-items-center">
